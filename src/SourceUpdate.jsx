...
export default function SourceUpdate({project,current,commit,acceptSaved,exclusive=fn=>fn(),busy,model,imageModelId,active=true}){
 ...
 return <SourceUpdateContent active={active}><SourceManuscript project={project} busy={busy} pendingBlockIds={pendingBlockIds} current={()=>current.current} onApply={desktop()?propose:undefined}/>
