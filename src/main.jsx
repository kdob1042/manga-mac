...
function App() {
  ...
  async function checkSync() {
    setPending(null);
    try {
      if(library) { const entry=library.entries.find(e=>e.id===library.active); const saved=await call('source_register',{...entry,episode}); setLibrary({...library,entries:saved.entries}); }
