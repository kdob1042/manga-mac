...
更新日：2026-09-19。設計の正本：本書。開発時は最新 `dev`、配布版の確認は対応する `main` の版を参照する。
...
以下の表は2026-09-14の設計改訂時点の記録。以後の操作と実装範囲は[USAGE](USAGE.md)、実行済み検証と残件はVALIDATIONを参照する。設計上の機能と実機検証済みの機能を区別する。
